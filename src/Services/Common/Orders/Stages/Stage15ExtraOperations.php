...
trait Stage15ExtraOperations
{
    ...
    protected function setKioskOrderAnswerChoiceLogic()
    {
        if ($this->system === SystemTypes::KIOSK) {
            ...
            if (isset($kiosk_data) && isset($kiosk_data['kiosk_entry_popup_question']) && (($kiosk_data['show_on_kiosk_takeaway'] && $this->payload['dine_in_type'] == 'take_out') || ($kiosk_data['show_on_kiosk_eatin'] && $this->payload['dine_in_type'] == 'dine_in'))) {
