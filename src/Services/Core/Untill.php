...
class Untill
{
    use GetTableItemsInfoRequest, GetActiveTableInfo, CreateOrder, GetPaymentsInfo, CloseOrder;
     ...
     * @return Untill
     */
    public function store(Model $store): Untill
    {
        $this->store = $store;
        return $this;
    }
     ...
     * @return Untill
     */
    public function table(Model $table): Untill
    {
        $this->table = $table;
        return $this;
    }
     ...
     * @return Untill
     */
    public function build(string $template, array $parameters = []): Untill
    {
     ...
     * @return Untill
     */
    public function setCredentials(): Untill
    {
        if (empty($this->store)) {
     ...
     * @return Untill
     */
    public function setTableNumber(): Untill
    {
        if (empty($this->table)) {
