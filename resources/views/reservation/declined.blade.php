								...
								<td align="center" style="padding:0 10px 14px 10px; border-bottom:1px solid #D5D5D5">
									<table class="em_wrapper" align="center" width="520" border="0" cellspacing="0" cellpadding="0" style="width:520px;">
										<tr>
											...
											<td class="em_width3" align="right" valign="top" width="45%">
												<table class="em_wrapper" align="left" width="100%" border="0" cellspacing="0" cellpadding="0" style="width:100%">
															...
															<table  align="right" width="168" border="0" cellspacing="0" cellpadding="0"  style="width:168px; background-color:#1B68AA; border-radius:4px; max-width:168px">
																<tr>
																	<td align="center" style="font-family:Ubuntu, Helvetica, Arial, sans-serif; font-size:14px; line-height:16px; font-weight:bold; font-style:normal; color:#FFFFFF; padding:8px 5px 8px 5px; ">
																		<a href="{{route('chat.index', $chat_link_url)}}" style="display:block; text-decoration:none; color:#FFFFFF">Vragen en opmerking</a>
																	</td>
																</tr>
															</table>
														</td>
									...
									<table class="em_wrapper" align="center" width="478" border="0" cellspacing="0" cellpadding="0" style="width:478px;">
										...
										<tr>
											<td align="left" style="font-family:Arial, Tahoma; font-size:18px; line-height:28px; font-weight:normal; font-style:normal; color:#000000; padding:40px 0 36px 0">
												...
												Helaas moeten wij uw reservering voor <b>{{ $storeRes->person }} personen</b> op <b>{{ $storeRes->res_date  }}</b> om <b>{{ $storeRes->from_time }}</b> afwijzen.
											</td>
										</tr>
									</table>
								</td>
                                        ...
                                        <tr>
                                            <td align="center" style="padding:18px 0 0 0;">
                                                <table  align="center" width="115" border="0" cellspacing="0" cellpadding="0"  style="width:115px; background-color:#1B68AA; border-radius:4px; max-width:168px">
                                                    <tr>
                                                        <td align="center" style="font-family:Ubuntu, Helvetica, Arial, sans-serif; font-size:14px; line-height:16px; font-weight:bold; font-style:normal; color:#FFFFFF; padding:8px 5px 8px 5px; ">
                                                            <a href="http://maps.google.com/maps?q=<?=$store->address?>" style="display:block; text-decoration:none; color:#FFFFFF">Toon op kaart</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                        ...
                                                        <td align="center" style="padding:20px 0 20px 0">
                                                            <table align="center" border="0" cellspacing="0" cellpadding="0" >
                                                                <tr>
                                                                    ...
                                                                    <td align="center">
                                                                        <a href="{{ $store->facebook_url }}"><img class="em_img" src="@companionGeneralHelper('getS3File',env('COMPANION_AWS_URL'). '/assets/facebook2.png')" style="display:block" width="24" height="24" border="0" alt="FB"/></a>
                                                                    </td>
                                                                    @endif
                                                                    <td width="5"></td>
                                                                    @if($store->instagram_url)
                                                                    <td align="center">
                                                                        <a href="{{ $store->instagram_url }}"><img class="em_img" src="@companionGeneralHelper('getS3File',env('COMPANION_AWS_URL'). '/assets/instagram.png')" style="display:block" width="24" height="24" border="0" alt="IG"/></a>
                                                                    </td>
                                                                    @endif
                                                                </tr>
                                                            </table>
                                                ...
                                                <table class="em_wrapper" align="center" width="478" border="0" cellspacing="0" cellpadding="0" style="width:478px; background-color:#F7F7F7; border-radius:12px">
                                                    <tr>
                                                        <td align="center" style="font-family:Arial, Tahoma; font-size:16px; line-height:24px; font-weight:normal; font-style:normal; color:#000000; padding:18px 10px 18px 10px">
                                                            ...
                                                            Klik <a href="{{route('chat.index', $chat_link_url)}}" style="color:#1B68AA; font-weight:bold">hier</a> om een bericht te plaatsen.
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <table class="em_wrapper" align="center" width="478" border="0" cellspacing="0" cellpadding="0" style="width:478px;">
                                        ...
                                        <tr>
                                            <td align="center" style="padding:10px 0 30px 0">
                                                <img src="@companionGeneralHelper('getS3File',env('COMPANION_AWS_URL'). '/assets/eat_card .png')" style="display:block" width="56" height="25" border="0" alt="et card"/>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
